...
export default defineConfig({
  ...
  locales: {
    root: {
      ...
      lang: 'zh',
      title: 'Melon 技术孵化器',
      description: '探索前端、后端与人工智能的创新技术，助力开发者成长的项目孵化中心',
      themeConfig: {
        siteTitle: '{ MELON Inc }',
        nav: [
          { text: '首页', link: '/' },
          ...
          },
          {
            text: '项目孵化',
            items: [
              { text: 'AI 心理咨询', link: 'https://ai-psycho-interface.netlify.app/' },
              { text: 'AI 学习路径', link: 'https://ai-learning-path.netlify.app/' },
            ],
          }
        ],
          ...
          '/web3/': [
            {
              ...
              items: [
                { text: '概述', link: '/web3/' },
                {
                  text: '智能合约',
                  items: [
                    { text: 'Solidity 基础', link: '/web3/smart-contracts/solidity/' },
                    { text: '合约安全', link: '/web3/smart-contracts/security/' }
                  ]
                },
                {
                  text: 'DApp 开发',
  ...
  themeConfig: {
    socialLinks: [{ icon: 'github', link: 'https://github.com/melon-incubator' }],
  },
});